package com.amp.domain.congestion.entity;
...
public class AudienceCongestionReport extends BaseTimeEntity {
    ...
    @Builder
    public AudienceCongestionReport(Audience audience, Stage stage,
